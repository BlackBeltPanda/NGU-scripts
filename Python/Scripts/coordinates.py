...
ITOPOD_CLOSE = Pixel(575, 450)
ITOPOD_AUTO = Pixel(710, 215)
HEALTH = Pixel(735, 416)
ADVENTURE_TOOLTIP = Pixel(445, 45)
OCR_AP_KILL_COUNT = OCRBox(479, 149, 747, 178)
OCR_ITOPOD_END_FLOOR = OCRBox(595, 250, 655, 275)
...
OCR_TM_NET = OCRBox(703, 494, 919, 515) #From TM Menu
...
OCR_CHALLENGE_LASER_COMPLETIONS = OCRBox(486, 478, 641, 496)
